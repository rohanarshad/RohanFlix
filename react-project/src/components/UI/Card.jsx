  ...
  return (
    <li className="w-full m-auto flex mt-[3.2rem]">
      <div className="relative w-64 h-[550px] mx-auto">
        {/* Poster */}
        <div className="absolute top-3 left-1/2 -translate-x-1/2 z-10 w-59">
          <img
            src={Poster}
            alt={imdbID}
        ...
        {/* Ticket Background */}
        <div className="absolute top-6 left-0 w-64 h-[28rem] bg-white rounded-md shadow-lg flex flex-col justify-end bg-white">
